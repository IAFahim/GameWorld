...
public class OrbitCameraAuthoring : MonoBehaviour
{
    ...
    public OrbitCameraControl orbitCameraControl;
    ...
    public class Baker : Baker<OrbitCameraAuthoring>
    {
        public override void Bake(OrbitCameraAuthoring authoring)
        {
            ...
            {
                FollowedCharacterEntity = GetEntity(authoring.orbitCameraTarget, TransformUsageFlags.Dynamic),
                LookDegreesDelta = authoring.orbitCameraControl.LookDegreesDelta,
                ZoomDelta = authoring.orbitCameraControl.ZoomDelta,
            });
